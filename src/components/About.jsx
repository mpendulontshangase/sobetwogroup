    ...
    <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16">
          ...
          <div className="mt-16">
            <h3 className="text-2xl font-bold text-black text-center">Our Values</h3>
            <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-3">
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <h4 className="text-xl font-semibold text-black">Integrity</h4>
              ...
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <h4 className="text-xl font-semibold text-black">Excellence</h4>
                <p className="mt-2 text-gray-600">
          ...
          <div className="mt-24">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 items-center">
              ...
              <div className="flex flex-col justify-center">
                <h3 className="text-2xl font-bold text-black">Meet Our Founder</h3>
                <h4 className="mt-2 text-xl text-gray-500">Mr M Ntshangase</h4>
                <p className="mt-4 text-lg text-gray-600">
